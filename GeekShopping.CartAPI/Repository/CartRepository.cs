...
namespace GeekShopping.CartAPI.Repository
{
    public class CartRepository : ICartRepository
    {
        ...
        public CartRepository(MySqlDataContext context, IMapper mapper)
        {
            _context = context;
            _mapper = mapper;
        ...
        public async Task<bool> ClearCart(string userId)
        {
            ...
            if(cartHeaders != null)
            {
                _context.CartDetails.RemoveRange(
                    _context.CartDetails.Where(c => c.CartHeaderId == cartHeaders.Id
                    ));
                _context.CartHeaders.Remove(cartHeaders);
